...
<body ng-controller="mainController">
						...
						<div class="shop-menu pull-right">
							...
							<ul class="nav navbar-nav">
								...
								<li ng-controller="headerController"><a href="#panier"><i
									...
									<div>
										{{total}}&#128; <span translate="TAXES">HT/mois</span>
									</div></li>
								...
								<li ng-controller="connectedController" role="presentation"
									...
									<ul class="dropdown-menu" role="menu">
										<li role="presentation"><a href="#compte/commandes"
											role="menuitem"> <i class="glyphicon glyphicon-list"></i>
												<span translate="HISTORIQUE"></span></a></li>
										<li role="presentation"><a href="#compte" role="menuitem">
												<i class="glyphicon glyphicon-cog"></i> <span
												translate="PARAMETRES"></span>
										</a></li>
										<li role="presentation"><a ng-click="disconnect()"
											role="menuitem"> <i class="glyphicon glyphicon-off"></i>
												<span translate="DECONNEXION"></span></a></li>
									</ul></li>
					...
					<ul class="nav navbar-nav navbar-collapse">
						...
						<li class="dropdown"><a href="#"><span
							...
							<ul role="menu" class="sub-menu">
								...
								<li><a href="#web"><span translate="WEB_HOSTING">Hébergement
											web</span></a></li>
								<li><a href="#mail"><span translate="MAIL_SERVER">Serveur
											mail</span></a></li>
							</ul></li>
						<li class="dropdown"><a href="#"><span
							...
							<ul role="menu" class="sub-menu">
								...
								<li><a href="#serveurDedie"><span
										translate="DEDICATED_SERVER">Serveur dédié</span></a></li>
								<li><a href="#partageFichier"><span
										translate="FILE_HOSTING_SERVICE">Serveur de partage</span></a></li>
							</ul></li>
						<li class="dropdown"><a href="#"><span
								translate="ENTREPRISES">Entreprises</span></a>
							<ul role="menu" class="sub-menu">
								<li><a href="#cloudDedie"><span
										translate="DEDICATED_CLOUD">Cloud dédié</span></a></li>
								<li><a href="#cloudPublic"><span
										translate="PUBLIC_CLOUD">Cloud public</span></a></li>
								<li><a href="#stockage"><span translate="DATA_STORAGE">Stockage</span></a></li>
							</ul></li>
						<li><a href="#about"><span translate="A_PROPOS">A
									propos</span></a></li>
						<li>
	...
	<footer class="footer">
		<div class="container">
			<p class="text-muted" style="text-align: center;">Copyright
				RenTech 2014 &copy; - Augustin HUSSON - Paul LABAT - Paul MARIAGE -
				Patrick PEREA</p>
		</div>
	</footer>
